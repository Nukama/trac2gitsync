...
**1.** **Verify authenticity and integrity of your downloads**, [particularly Qubes iso](/doc/VerifyingSignatures).
...
**8.** Before you [assign a USB controller to a VM](/doc/AssigningDevices) check if any **input devices** are included in that controller.
