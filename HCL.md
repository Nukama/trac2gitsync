...
If you want to submit any new data please run 'qubes-hcl-report' script (in dom0) and send the results ('HCL Info' - contets of the .txt file) to [the mailing list](/doc/QubesLists) with the following details included:
