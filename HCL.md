...
This list contains information about the [latest stable release](/doc/HCL#LatestStableRelease) (**R1**) and the [latest development release](/doc/HCL#LatestDevelopmentRelease) (**R2RC1**). You can also find information about the [previous releases](/doc/HCL#PreviousReleases) here.
...
Users are encouraged to submit their HCL reports for the benefit of further Qubes development and other users. If you would like to submit your HCL report, please send the **HCL Info** `.txt` file to `qubes-users@googlegroups.com` (see [here](/doc/QubesLists) information about the mailing lists) with the subject `HCL - <your machine model name>`.
