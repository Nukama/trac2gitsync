...
**NOTE:** If you're migrating from a previous system (e.g. Alpha 1), and want to restore your previous AppVMs from a backup, use the [qvm-backup-restore](/doc/BackupRestore) tool.
...
Read more about Qubes networking [here](/doc/QubesNet).
...
1.  On processors with Hyper-Threading support, such as Intel Core i5/i7 (but not Core 2 Duo), the AppVM might lock up after a resume from S3 sleep. A temporary work around for this is to disable [HyperThreading?](/doc/HyperThreading) in BIOS.
